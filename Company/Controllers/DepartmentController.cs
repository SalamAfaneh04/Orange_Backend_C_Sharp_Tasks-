...
namespace Company.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DeptName")] DepartmentModel departmentModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DeptName")] DepartmentModel departmentModel)
        {
